export const myProjects = [
  {
    ...
    title: "Netflix Clone",
    description:
      "A Netflix application clone built using Flutter for mobile platforms.",
    subDescription: [
      "Developed a cross-platform mobile application using Flutter framework.",
      "Implemented responsive UI design similar to Netflix interface.",
  ...
  {
    id: 2,
    title: "RagChatbot LLM",
    description:
      "A RAG (Retrieval-Augmented Generation) chatbot using Llama 3.2 model for intelligent conversations.",
    subDescription: [
      "Implemented RAG architecture for enhanced AI responses using Llama 3.2.",
      "Built retrieval system for context-aware conversation handling.",
...

  {
    ...
    subDescription: [
      ...
      "Implemented 3D graphics using Three.js and React Three Fiber.",
